...
public class Main {
	...
	public static void main(String[] args) {
		...
		Membro user1 = new Funcionario("Max", 241957, "Campinas-SP", "m241957@dac.unicamp.br", LocalDate.now(), new ArrayList<Multa>(), new LinkedList<Emprestimo>());
		...
		System.out.println("testando multa:");
		...
		Emprestimo emprestimoAtrasado = new Emprestimo(livro1, dataAtrasada.minusDays(10), dataAtrasada, user1);
		emprestimoLista.add(emprestimoAtrasado);
		user1.setEmprestimos(emprestimoLista);
		biblioteca.addEmprestimo(emprestimoAtrasado);
		emprestimo = user1.getEmprestimos().get(0);
		user1.makeDevolucao(emprestimo, biblioteca);
		System.out.println(user1);
		System.out.println();
